...
class App extends React.Component {
  render() {
    return (
      <BaseScene>   
        <MovingAudioSource direction={1} url="/assets/music/aphro_6ch_comp.wav"></MovingAudioSource>
        <MovingAudioSource direction={-1} url="/assets/music/eros_6ch_comp.wav"></MovingAudioSource>
